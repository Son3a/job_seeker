...
//import com.nsb.job_seeker.databinding.ActivitySignUpBinding;
//
...
//        user.put(Program.KEY_NAME, binding.inputName.getText().toString());
//        user.put(Program.KEY_EMAIL, binding.inputEmail.getText().toString());
//        user.put(Program.KEY_PASSWORD, binding.inputPassword.getText().toString());
...
//                    preferenceManager.putString(Program.KEY_NAME, binding.inputName.getText().toString());
