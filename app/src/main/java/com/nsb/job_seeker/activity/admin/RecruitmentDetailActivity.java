...
public class RecruitmentDetailActivity extends BaseActivity {
    ...
    private String url = Constant.url_dev + "/job/detail?id=";
...
//                        salary = "VND " + Constant.formatSalary(salary);
//                    }
                    salary = Constant.formatSalary(salary.replaceAll("\\D+", ""));
                    ...
                    tvDescJob.setText(Constant.formatStringToBullet(job.getString("description")));
                    tvJobReq.setText(Constant.formatStringToBullet(job.getString("requirement")));
    ...
    private void deleteRecruitmentAPI() throws JSONException {
        String urlDeleteRecruitment = Constant.url_dev + "/job/delete";
    ...
    private void clickEditRecruitment() {
        icEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("detailJob", Constant.formatStringFromBullet(tvDescJob.getText().toString()));
                i.putExtra("jobReq", Constant.formatStringFromBullet(tvJobReq.getText().toString()));
                startActivity(i);
            }
        });
    }
